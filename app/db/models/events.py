...
class EventCandidateModel(TimestampMixin, Base):
    ...
    capacity_text: Mapped[str] = mapped_column(Text, nullable=True)
    setlist_json: Mapped[str] = mapped_column(Text, nullable=True)
    merchandise_json: Mapped[str] = mapped_column(Text, nullable=True)
