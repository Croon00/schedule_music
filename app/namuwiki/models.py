...
class NamuWikiSongArticleRequest(BaseModel):
    ...
    illustrator: str | None = Field(default=None, max_length=160)
    illustrator_ko: str | None = Field(default=None, max_length=160)
    video: str | None = Field(default=None, max_length=160)
    video_ko: str | None = Field(default=None, max_length=160)
    producer: str | None = Field(default=None, max_length=160)
    producer_ko: str | None = Field(default=None, max_length=160)
    executive_producer: str | None = Field(default=None, max_length=160)
    executive_producer_ko: str | None = Field(default=None, max_length=160)
    recording_director: str | None = Field(default=None, max_length=160)
    recording_director_ko: str | None = Field(default=None, max_length=160)
    recording_mixing: str | None = Field(default=None, max_length=160)
    recording_mixing_ko: str | None = Field(default=None, max_length=160)
